...
func on_input(event: InputEvent):
	if GodotX.xor(event.is_action_pressed("ui_up"), event.is_action_pressed("ui_down")) && !options[cur_option].binding:
	...
	elif GodotX.xor(event.is_action_pressed("ui_left"), event.is_action_pressed("ui_right")) && !options[cur_option].binding:
	...
	elif event.is_action_pressed("ui_cancel") && !options[cur_option].binding:
		on_back()
